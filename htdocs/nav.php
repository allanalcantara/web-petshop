...
abaixo para acessá-la.</h6>
    ...
    <div class="container" style="color: #000;">
      <input type="text" placeholder="Enter Username" name="usuario" style="color: #000;">
      <input type="password" placeholder="Enter Password" name="senha"style="color: #000;">        
...
<div id="modal-atendimento" class="modal" style="color: #000;">
  ...
  <form class="modal-content animate" action="contato/contato.php" method="POST">
